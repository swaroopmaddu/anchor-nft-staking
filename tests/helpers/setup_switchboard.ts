...
const setupSwitchboard = async(provider, lootboxProgram, payer) => {
  ...
  console.log(`Switchboard loaded at ${switchboard.mint.address.toString()}`);
...
export default setupSwitchboard;